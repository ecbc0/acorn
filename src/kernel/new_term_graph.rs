...
/// The goal of the NewTermGraph is to find a contradiction.
/// When we do, we need to explain to the outside world why this is actually a contradiction.
/// The NewTermGraphContradiction encodes this.
///
/// Warning!
...
/// So, beware.
#[derive(Debug, Eq, PartialEq)]
pub struct NewTermGraphContradiction {
...
/// The NewTermGraph stores concrete terms, along with relationships between them that represent
...
impl NewTermGraph {
    ...
    pub fn get_contradiction_trace(&self) -> Option<NewTermGraphContradiction> {
        ...
        Some(NewTermGraphContradiction {
...
/// A test wrapper that combines a NewTermGraph with its KernelContext.
#[cfg(test)]
